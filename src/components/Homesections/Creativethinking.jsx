...
export const Creativethinking = () => {
  return (
    <div >
        <div className='flex flex-wrap justify-between px-10 sm:px-24 content-center my-20 pb-24 relative overflow-hidden' data-aos="fade-up">
            {/* left side */}
            ...
            {/* right side */}
            <div className='lg:w-[50%] flex gap-x-5 justify-center self-center  relative lg:left-20 sm:left-24 top-14'>
